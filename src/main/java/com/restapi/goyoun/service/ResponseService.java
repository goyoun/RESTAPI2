package com.restapi.goyoun.service;

import com.restapi.goyoun.model.response.CommonResult;
import com.restapi.goyoun.model.response.ListResult;
...
public class ResponseService {
    ...
    public CommonResult getFailResult(int code, String msg) {
        ...
        result.setCode(code); // setCode : 응답코드번호 >= 정상, < 0 비정상
        result.setMsg(msg); // setMsg 응답메세지
        return result;
    }
